...
You could optionally just link out to https://widget.curling.io/en/clubs/yt/competitions instead of bothering with these widgets.
...
Your current scoreboard screen is at: http://www.yukoncurling.ca/Championship/Live-Scores
      ...
      var cio_results = Elm.Results.init(
        {
          ...
          flags: {
            subdomain: "yt", // REQUIRED. This is your club's Curling I/O subdomain. For example, if your Curling I/O URL begins with "demo.curling.io" then the "demo" part would be your subdomain.
...
The current games widget is meant to be embedded in a sidebar on the home page, if you have one.
It will list only the current games that are being played across all of your competitions with their scores.

Place the following raw javascript code into your sidebar to display the current games widget:
